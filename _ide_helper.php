...
namespace  { 
             ...
             * @static 
             */ 
            public static function whereLike($attribute, $searchTerm)
            {
                                return \Illuminate\Database\Eloquent\Builder::whereLike($attribute, $searchTerm);
            }
            ...
            {
                                return \Illuminate\Database\Eloquent\Builder::search($term);
            }
