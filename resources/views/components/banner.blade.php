<div class="sticky z-50 bottom-0 w-full text-white bg-blue-500 dark:bg-blue-600">
    <div class="container flex items-center justify-between px-6 py-4 mx-auto">
        ...
        <p class="mx-3 text-sm"><strong>sempersum.pl</strong> nie jest jeszcze skończone. Poprzednia wersja (PDF) jest do
            pobrania
            <a href="https://spiewnik.sempersum.pl" class="hover:underline font-bold">tutaj</a>
        </p>
    </div>
</div>
