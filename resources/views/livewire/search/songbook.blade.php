<div
    class="px-1 pt-3 text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 dark:hover:text-gray-400 md:hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300">
    <div class="relative">
        <label for="song_search" class="absolute inset-y-0 left-0 flex items-center pl-2">
        ...
        <input wire:model="term"
               ...
               type="text" name="search" placeholder="Wyszukaj..." id="song_search"
               autocomplete="off"
        >
    </div>
    @if(!empty($term))
