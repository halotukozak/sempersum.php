<div class="p-6 bg-white w-full dark:bg-gray-600 rounded-lg">
    <div class="pt-2 relative mx-auto text-gray-600 ">
        ...
        <div wire:loading.grid
             class="animate-pulse px-6 py-4 mx-auto bg-white rounded-lg shadow-lg dark:bg-gray-800 shadow-md mt-16">
            ...
            <p class="mt-6">
                <x-jet-secondary-button class="my-1">&nbsp;&nbsp;&nbsp;&nbsp;</x-jet-secondary-button>
                <x-jet-secondary-button class="my-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </x-jet-secondary-button>
                <x-jet-secondary-button class="my-1">&nbsp;&nbsp;&nbsp;&nbsp;</x-jet-secondary-button>
            </p>
            <p class="">
                <x-jet-secondary-button class="my-1">&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;</x-jet-secondary-button>
                <x-jet-secondary-button class="my-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </x-jet-secondary-button>
                <x-jet-secondary-button class="my-1">&nbsp;&nbsp;&nbsp;&nbsp;</x-jet-secondary-button>
            </p>
        ...
        <div wire:loading.grid
            ...
            <p class="">
                <x-jet-secondary-button class="my-1">&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;</x-jet-secondary-button>
                <x-jet-secondary-button class="my-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </x-jet-secondary-button>
                <x-jet-secondary-button class="my-1">&nbsp;&nbsp;&nbsp;&nbsp;</x-jet-secondary-button>
            </p>
